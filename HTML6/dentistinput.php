...
<tr>
<td>Treatment:</td><td><input type="text" name="treatmentn" value="<?php echo $treatmentn;?>"/></td>
</tr>

<tr>
<td>Checkin:</td><td><input type="text" name="checkin" value="<?php echo $checkin;?>"/></td>
</tr>
